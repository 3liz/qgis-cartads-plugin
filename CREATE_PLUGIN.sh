...
PLUGIN_DIR_NAME=cartads
PLUGIN_CLASS_NAME=CartAds
PLUGIN_PG_SCHEMA=cartads
PLUGIN_PG_SERVICE=pg_cartads_service
PLUGIN_GITHUB_REPOSITORY=qgis-cartads-plugin
PLUGIN_TRANSIFEX_KEY=qgis-cartads-plugin
